...
public class MethodCall2 {
	public static void main(String[] args) throws Exception{
		...
		//1. YoilTellerMV 객체를 생성 
		Class clazz = Class.forName("com.fastcampus.ch2.YoilTellerMVC2");
		Object obj = clazz.newInstance();
		
		//2. main 메서드의 정보를 가저온다.
		Method main = clazz.getDeclaredMethod("main", int.class, int.class, int.class, Model.class);
		
		//3.모델을 생성
		Model model = new BindingAwareModelMap(); //모델이 인터페이스라서 BindingAwareModelMap()이라는 구현체로 생성한다.
